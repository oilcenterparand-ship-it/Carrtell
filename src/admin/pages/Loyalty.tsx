        ...
        <section className="rounded-3xl border border-white/10 bg-slate-900 p-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ...
              ['review_photo_points','امتیاز ثبت عکس نظر'], ['health_record_points','امتیاز تکمیل پرونده خودرو'], ['referral_points','امتیاز معرفی دوست'],
              ['package_purchase_points','امتیاز خرید پکیج'], ['first_onsite_service_points','امتیاز اولین سرویس در محل'],
              ['referral_reward_toman','جایزه معرفی'], ['referred_discount_toman','تخفیف دوست معرفی‌شده'], ['silver_min','حداقل نقره‌ای'],
              ['gold_min','حداقل طلایی'], ['diamond_min','حداقل الماسی']
            ].map(([key,label]) => (
