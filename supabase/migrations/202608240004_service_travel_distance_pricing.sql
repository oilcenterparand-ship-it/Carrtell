-- Carrtell V3.5.0 - distance based service travel pricing
...
create table if not exists public.service_travel_quotes (
  ...
  billable_distance_km integer not null,
  base_fee numeric not null,
  distance_fee numeric not null,
  traffic_surcharge numeric not null default 0,
  traffic_zone boolean not null default false,
