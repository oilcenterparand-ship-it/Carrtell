          ...
          <aside ref={menuRef} className="ct-new-drawer" onClick={(event) => event.stopPropagation()}>
            ...
            <div className="ct-new-drawer-scroll">
              <nav className="ct-new-drawer-nav">
                ...
                {user && <Link to="/dashboard"><span aria-hidden="true">👤</span><span>پروفایل من</span></Link>}
                {user && <Link to="/dashboard#orders"><span aria-hidden="true">📦</span><span>سفارش‌های من</span></Link>}
                {user && <Link to="/dashboard#addresses"><span aria-hidden="true">📍</span><span>آدرس‌های من</span></Link>}
            ...
            <div className="ct-new-drawer-footer">
              {!authLoading && !user && (
                <div className="ct-new-drawer-guest-note" data-testid="guest-drawer-public-note">
                  <ShieldCheck className="h-5 w-5" />
                  <span>
                    <b>خرید و رزرو بدون ورود</b>
                    <small>برای استفاده از منو، فروشگاه و رزرو سرویس نیازی به ساخت حساب نیست.</small>
                  </span>
                </div>
              )}
