...
export default function BookingScreen({ onGoCart, onContinueShopping }: { onGoCart?: () => void; onContinueShopping?: () => void }) {
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      <SectionHeader title="رزرو سرویس" subtitle="سرویس در محل برای خودروی شما" />
      <View style={styles.card}>
        <Text style={styles.title}>رزرو سرویس در محل</Text>
